...
export interface ApiDolarDolar extends Struct.CollectionTypeSchema {
  collectionName: 'dolars';
  info: {
    description: '';
    displayName: 'dolar';
    pluralName: 'dolars';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::dolar.dolar'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiProductoProducto extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    isOffer: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    masinfo: Schema.Attribute.String;
    nombre: Schema.Attribute.String & Schema.Attribute.Required;
    precioUSD: Schema.Attribute.Decimal & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    subcategoria: Schema.Attribute.Relation<
      'oneToOne',
      'api::subcategoria.subcategoria'
    >;
    subsubcategoria: Schema.Attribute.Relation<
      'oneToOne',
      'api::subsubcategoria.subsubcategoria'
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiSubcategoriaSubcategoria
  ...
  attributes: {
    ...
    nombre: Schema.Attribute.String &
      ...
      Schema.Attribute.Unique;
    publishedAt: Schema.Attribute.DateTime;
    subsubcategorias: Schema.Attribute.Relation<
      'oneToMany',
      'api::subsubcategoria.subsubcategoria'
    >;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiSubsubcategoriaSubsubcategoria
  extends Struct.CollectionTypeSchema {
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::dolar.dolar': ApiDolarDolar;
      'api::producto.producto': ApiProductoProducto;
      'api::subcategoria.subcategoria': ApiSubcategoriaSubcategoria;
      'api::subsubcategoria.subsubcategoria': ApiSubsubcategoriaSubsubcategoria;
